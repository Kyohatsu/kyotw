...
let errorText = {
        buildings: "Failed to retrieve building data from the server! Please try again later.",
        units: "Failed to retrieve unit data from the server! Please try again later.",
        unitsCost: "Failed to retrieve unit resource costs from the server! Please try again later.",
        speed: "Failed to retrieve server speed from the server! Please try again later."
};
let prompts = {
        text: [`This code can be used during import.`,
               `\n`,
               `\n`,
               `With it, you can save your profile or send it to someone else.`,
               `\n`,
               `Copy to clipboard: CTRL+C.`].join('')
};
let helpTooltip = {
        resource: [`Resource bonus:`,
                   `<br/>`,
                   `<br/>`,
                   ` :: Here you can specify the percentage increase in wood, clay, and iron production.`].join(''),
        pop: [`Population bonus:`,
                   `<br/>`,
                   `<br/>`,
                   ` :: Here you can specify the percentage increase in farm capacity.`,
                   ` :: Bonus village, flag, and inventory booster can be set separately.`].join(''),
        haul: [`Carrying capacity bonus:`,
                   `<br/>`,
                   `<br/>`,
                   ` :: Here you can specify the percentage increase in unit transport capacity.`,
                   ` :: Flag and inventory booster can be set separately.`].join(''),
        recruit: [`Training bonus:`,
                   `<br/>`,
                   `<br/>`,
                   ` :: Here you can specify the percentage increase in training speed for barracks, stable, workshop, and academy.`].join(''),
        market: [`Market bonus:`,
                   `<br/>`,
                   `<br/>`,
                   ` :: Here you can specify the percentage increase in the number of merchants.`,
                   ` :: Bonus village and inventory booster can be set separately.`].join(''),
        storage: [`Storage bonus:`,
                   `<br/>`,
                   `<br/>`,
                   ` :: Here you can specify the percentage increase in storage capacity.`,
                   ` :: Bonus village and inventory booster can be set separately.`].join('')
};
let game = window.image_base;
let imageSrc = {
        main: game + "buildings/mid/main3.png",                  // Main building
        barracks: game + "buildings/mid/barracks3.png",          // Barracks
        stable: game + "buildings/mid/stable3.png",              // Stable
        garage: game + "buildings/mid/garage3.png",              // Workshop (Garage)
        church: game + "buildings/mid/church3.png",              // Church
        church_f: game + "buildings/mid/church1.png",            // First-level Church
        watchtower: game + "buildings/mid/watchtower3.png",      // Watchtower
        academy: game + "buildings/mid/snob1.png",               // Academy
        smith: game + "buildings/mid/smith3.png",                // Smithy
        place: game + "buildings/mid/place1.png",                // Rally Point
        statue: game + "buildings/mid/statue1.png",              // Statue
        market: game + "buildings/mid/market3.png",              // Market
        timber_camp: game + "buildings/mid/wood3.png",           // Timber Camp
        clay_pit: game + "buildings/mid/stone3.png",             // Clay Pit
        iron_mine: game + "buildings/mid/iron3.png",             // Iron Mine
        farm: game + "buildings/mid/farm3.png",                  // Farm
        warehouse: game + "buildings/mid/storage3.png",          // Warehouse
        hide: game + "buildings/mid/hide1.png",                  // Hiding Place
        wall: game + "buildings/mid/wall3.png",                  // Wall
        spear: game + "unit/unit_spear.png",                     // Spear Fighter
        sword: game + "unit/unit_sword.png",                     // Swordsman
        axe: game + "unit/unit_axe.png",                         // Axeman
        archer: game + "unit/unit_archer.png",                   // Archer
        spy: game + "unit/unit_spy.png",                         // Scout
        light: game + "unit/unit_light.png",                     // Light Cavalry
        marcher: game + "unit/unit_marcher.png",                 // Mounted Archer
        heavy: game + "unit/unit_heavy.png",                     // Heavy Cavalry
        ram: game + "unit/unit_ram.png",                         // Ram
        catapult: game + "unit/unit_catapult.png",               // Catapult
        knight: game + "unit/unit_knight.png",                   // Paladin (Knight)
        snob: game + "unit/unit_snob.png",                       // Nobleman
        militia: game + "unit/unit_militia.png",                 // Militia
        wood: game + "holz.png",                                 // Wood icon
        stone: game + "lehm.png",                                // Clay icon
        iron: game + "eisen.png",                                // Iron icon
        header: game + "face.png",                               // Header image
        gold: game + "gold.png",                                 // Gold icon
        popFlag: game + "flags/medium/6_5.png",                  // Population bonus flag
        haulFlag: game + "flags/medium/8_5.png",                 // Carrying capacity bonus flag
        inventory: game + "icons/inventory.png",                 // Inventory icon
        bonusVillage: game + "/map_new/b1.png",                  // Bonus village icon
        questionMark: game + "questionmark.png",                 // Help icon (question mark)
        time: game + "time.png"                                  // Time icon
};
        ...
        <div style="float: left;margin-right:10px">
            <table class="inlineTable modes">
		        <tbody>
			        ...
			        <tr>
				        <td><img src=${imageSrc.main}>Headquarters</td>
                    ...
                    <tr>
                        <td><img src=${imageSrc.timber_camp}>Lumberjack</td>
                    ...
                    <tr>
                        ...
                        <td class="crosshatchedright" colspan="2">&#x21E6; Current level costs</td>
                    </tr>
                    <tr>
...
<div style="float: left;margin-right:10px">
    <table class="inlineTable">
        <tbody>
            ...
            <tr>
                <td><img src=${imageSrc.spear}>Spearman</td>
        ...
        <td class="sumbuildtime" rowspan="4">00:00:00:00</td>
            ...
            <tr>
                ...
                <tr>
                    <td><img src=${imageSrc.ram}>Battering Ram</td>
                ...
                <tr>
                    <td><img src=${imageSrc.knight}>Knight</td>
...
<table class="inlineTable bonus">
    <tbody>
        <tr>
            <th colspan="3">Resource Bonus<img src=${imageSrc.questionMark} title="${helpTooltip.resource}" class="tooltip"></th>
            <th class="space"></th>
            <th colspan="3">Population Bonus<img src=${imageSrc.questionMark} title="${helpTooltip.pop}" class="tooltip"></th>
            <th class="space"></th>
            <th colspan="2">Carrying Capacity Bonus<img src=${imageSrc.questionMark} title="${helpTooltip.haul}" class="tooltip"></th>
        </tr>
        <tr>
...
<table class="inlineTable bonus">
    <tbody>
        <tr>
            ...
            <th class="space"></th>
            <th colspan="2">Storage Bonus<img src=${imageSrc.questionMark} title="${helpTooltip.storage}" class="tooltip"></th>
        </tr>
        <tr>
...
<table class="inlineTable border">
    <tbody>
        <tr>
            <td>
                <label for="sablon">Profiles: </label>
                <select id="sablon">
...
<div style="float: left;margin-right:10px">
    <table class="inlineTable modesb">
        <tbody>
            <tr>
                <th colspan="2">Building Properties</th>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 50%"><img src=${imageSrc.header}>Occupied Population Space</td>
                <td class="property" id="locked" style="width: 50%">0</td>
            </tr>
            <tr>
                <td style="width: 50%"><img src=${imageSrc.header}>Free Population Space</td>
            ...
            <tr>
                <td style="width: 50%"><img src=${imageSrc.market}>Number of Merchants</td>
...
function sendMessage() {
    createIssue("BugReports", "oreg-kh", "bug/feedback", issue.text, token)
}
...
sideBarHTML = `
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <textarea id="issueText" placeholder="Describe the issue..." rows="10" cols="50"></textarea>
        <button id="sendIssue" type="button" onclick="sendMessage()">Send</button>
        </br>
        <textarea id="imageURL" placeholder="Image link" rows="1" cols="50"></textarea>
        <button id="addURL" type="button" onclick="addURL()">Add</button>
    </div>
`;
...
function createIssue(repoName, repoOwner, issueTitle, issueBody, accessToken) {
    ...
    $.ajax({
        ...
        success: function(msg){
            UI.SuccessMessage("Your message has been successfully sent!", 5000);
        },
...
// Retrieve building information, max once per hour
...
// Retrieve server speed, max once per hour
...
// Stores input values in an array
function getAllInputValue() {
    var array = [];
    for (var i = 0; i < 48; i++) {
        array.push($("#myTable").find("input").eq(i).val());
    }
    var name = prompt("Please enter the name under which you'd like to save your settings!");
    return { array, name }
}

// Stores input values in localStorage and adds a new option to profiles
function store() {
    var pre = getAllInputValue();
    name = "oregsaver_" + pre.name;
    var object = {
        "inputs": pre.array
    };
...
// Loads profiles into the dropdown list
function loadSelectMenu() {
    for (var key in localStorage) {
        if (key.includes("oregsaver")) {
            createOption(key.split("_")[1]);
        }
    }
}

// Removes the selected item from the dropdown list
...
// Enables the building if prerequisites for construction are met; buildings that don't exist on the server won't be enabled
...
// Disables all units except spearman and swordsman, since they have no prerequisites and exist on all servers
function resetUnit() {
...
// Disables all buildings that have prerequisites
...
// Calculates wood cost for each building level
function woodCost() {
    for (var i = 0; i < buildings.length; i++) {
...
// Calculates clay cost for each building level
function stoneCost() {
    for (var i = 0; i < buildings.length; i++) {
        building_level = Number($(".building").eq(i).val());
...
// Calculates iron cost for each building level
function ironCost() {
    for (var i = 0; i < buildings.length; i++) {
        building_level = Number($(".building").eq(i).val());
...
// Calculates population cost for each building level
function popCost() {
    for (var i = 0; i < buildings.length; i++) {
        building_level = Number($(".building").eq(i).val());
...
// Calculates points for each building level
function points() {
    for (var i = 0; i < buildings.length; i++) {
        building_level = Number($(".building").eq(i).val());
...
// Calculates total village score
...
// Calculates the resources hidden by the hiding place
...
// Calculates the number of merchants
...
// Calculates the warehouse capacity
function capacity() {
...
// Calculates the wall defense bonus
function wallBonus() {
...
// Calculates farm population capacity
function population() {
...
// Calculates the carrying capacity of units
function unitsHaul() {
    barracks_level = Number($("#barracks").val());
    stable_level = Number($("#stable").val());
    garage_level = Number($("#garage").val());
...
// Calculates the farm space occupied by units
function unitsPop() {
    barracks_level = Number($("#barracks").val());
    stable_level = Number($("#stable").val());
    garage_level = Number($("#garage").val());
...
// Sums the training time of units per building
...
// Calculates occupied farm space
...
// Highlights occupied and free farm space in red if over capacity
function redClass() {
...
// Calculates warehouse capacity bonus
...
// Calculates resource production bonus
...
// Calculates current building level costs
...
// Formats numbers with "." as thousands separator
...
function byebye() {
    createMessage("SuccessMessage", "See you next time!", 2000);
}
...
$(".building, .unit, .bon").on("keyup input", function(event) {
    ...
    if (regExp.test(val) || value > max || value < min || ((keyCode < 7 || keyCode > 9) && (keyCode < 48 || keyCode > 57) && (keyCode < 96 || keyCode > 105))) {
        ...
        if (classname == "building") {
            createMessage("ErrorMessage", `This building level is invalid! Minimum: ${min}, Maximum: ${max}`, 1500);
        }
        if (classname == "unit") {
            createMessage("ErrorMessage", `Invalid unit count! Minimum: ${min}, Maximum: ${max}`, 1500);
        }
        if (classname == "bon") {
            createMessage("ErrorMessage", `Invalid bonus value! Minimum: ${min}, Maximum: ${max}`, 1500);
        }
    } else {
        if (classname == "building") {
            buildingsFunctions();
...
// Minimum radio button event handler
function minimum() {
    for (var i = 0; i < buildings.length; i++) {
...
// Maximum radio button event handler
function maximum() {
    for (var i = 0; i < buildings.length; i++) {
...
// Checks building and unit prerequisites
function select() {
